      ...
      <div className="max-wide" style={{ padding: '40px' }}>
        <div className="row between items-baseline" style={{ marginBottom: 24 }}>
          ...
          <div className="row gap-12">
            ...
            <button className="btn btn-solid">Send as email</button>
          </div>
        </div>
          ...
          <div className="col gap-24">
            ...
            <div>
              ...
              <div className="col gap-8">
                {[
                  ['v3 · Current', true],
                  ['v2 · Tighter crop', false],
                  ['v1 · First pass', false],
                ].map(([v, active]) => (
                  <div key={v} className="row between items-center" style={{ padding: '6px 8px', background: active ? 'var(--paper-3)' : 'transparent' }}>
                    <span className="mono-sm">{v}</span>
                    {active && <span className="chip chip-solid">Active</span>}
                  </div>
                ))}
                <button className="btn btn-sm" style={{ marginTop: 6 }}>Regenerate →</button>
              </div>
            </div>
          </div>
        </div>
